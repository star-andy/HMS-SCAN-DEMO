...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        Log.d("qyang",String.valueOf(mScreenWidth));
        Log.d("qyang",String.valueOf(mScreenHeight));
        int scanFrameSize = (int) (SCAN_FRAME_SIZE * density);
        Log.d("qyang",String.valueOf(scanFrameSize));
        ...
        Log.d("qyang",String.valueOf(rect.left));
        Log.d("qyang",String.valueOf(rect.right));
        Log.d("qyang",String.valueOf(rect.top));
        Log.d("qyang",String.valueOf(rect.bottom));
        Log.d("qyang",rect.toString());
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_CODE_PHOTO) {
            try {
                ...
                if (hmsScans != null && hmsScans.length > 0 && hmsScans[0] != null && !TextUtils.isEmpty(hmsScans[0].getOriginalValue())) {
                    Log.d("qyang", hmsScans[0].getShowResult());
                    Intent intent = new Intent();
