...
public class ScanResultView4 extends View {
    ...
    public ScanResultView4(Context context) {
        super(context);
    }

    public ScanResultView4(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
...
//                widthScaleFactor = (float) canvas.getWidth() / (float) previewWidth;
                widthScaleFactor = (float)  canvas.getWidth() /1440f; // height
                heightScaleFactor = (float) 1920f / (float) 2560f; // width

                widthScaleFactor = (float)  canvas.getWidth() / 1080f;
                heightScaleFactor = (float) 2340f / (float) 2340f;
...
//                heightScaleFactor = (float) 1572 / (float) 1920;
    ...
    public static class HmsScanGraphic {
        ...
        private ScanResultView4 scanResultView;

        public HmsScanGraphic(ScanResultView4 scanResultView, HmsScan hmsScan) {
            this(scanResultView, hmsScan, Color.WHITE);
        }

        public HmsScanGraphic(ScanResultView4 scanResultView, HmsScan hmsScan, int color) {
...
//            scanResultView.heightScaleFactor = 1.0f;
            ...
            other.left = canvas.getWidth()-scaleX(rect.top - 118);

            other.top = scaleY(rect.left);
            other.right = canvas.getWidth()-scaleX(rect.bottom - 118);
